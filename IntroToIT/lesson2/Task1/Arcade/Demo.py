...
img_file_hero =     path.dirname(__file__)+ '/Flesh.png'
img_file_enemy =    path.dirname(__file__)+ '/Djoger.png' 
img_file_bomb =     path.dirname(__file__)+ '/Batman.png'
img_file_princess = path.dirname(__file__)+ '/Pengvin.png'
FPS = 60
